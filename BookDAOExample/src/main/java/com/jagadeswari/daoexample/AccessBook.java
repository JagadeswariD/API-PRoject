package com.jagadeswari.daoexample;

import java.sql.SQLException;
import java.util.ArrayList;

import com.jagadeswari.daoexample.daoimplementation.BookDaoImpl;
import com.jagadeswari.daoexample.daointerface.BookDao;
import com.jagadeswari.daoexample.model.Books;

public class AccessBook {
	public static void main(String[] args) {
		BookDao bookDao = new BookDaoImpl();

		// creating object BookDao bookDao = new BookDaoImpl();
		...
		System.out.println(" ====== Display book details by id ====");
		try {
			Books b = new Books();
			b = bookDao.getBookById(1);
			int ISBN = b.getIsbn();
